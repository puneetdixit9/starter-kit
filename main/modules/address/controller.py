...
class AddressController:
    ...
    def get_addresses(cls, auth_user: AuthUser) -> list[dict]:
        """
        To get the list of addresses of logged-in auth_user. If auth_user is Admin
    ...
    def get_address_by_address_id(cls, address_id: int, auth_user: AuthUser) -> dict:
        """
        To get an address by address_id.
        :param address_id:
        :param auth_user:
        :return dict:
        """
    ...
    def update_address(cls, address_id: int, updated_address: dict, auth_user: AuthUser) -> dict:
        """
        To update the address. It required a valid address_id.
        :param address_id:
    ...
    def delete_address(cls, address_id, auth_user):
        """
        To delete a address by address_id.
        :param address_id:
        :param auth_user:
        :return dict:
        """
    ...
    def required_checks(cls, auth_user: AuthUser, address: Address):
        """
        To check the required checks and raise a custom exception if any
